...
// NetworkInstance_Protocol_Bgp_PeerGroup_SendCommunityTypePath represents the /openconfig-network-instance/network-instances/network-instance/protocols/protocol/bgp/peer-groups/peer-group/config/send-community-type YANG schema element.
type NetworkInstance_Protocol_Bgp_PeerGroup_SendCommunityTypePath struct {
	*ygot.NodePath
}

// NetworkInstance_Protocol_Bgp_PeerGroup_SendCommunityTypePathAny represents the wildcard version of the /openconfig-network-instance/network-instances/network-instance/protocols/protocol/bgp/peer-groups/peer-group/config/send-community-type YANG schema element.
...
func (n *NetworkInstance_Protocol_Bgp_PeerGroupPath) SendCommunityType() *NetworkInstance_Protocol_Bgp_PeerGroup_SendCommunityTypePath {
	return &NetworkInstance_Protocol_Bgp_PeerGroup_SendCommunityTypePath{
		NodePath: ygot.NewNodePath(
...
func (n *NetworkInstance_Protocol_Bgp_PeerGroupPathAny) SendCommunityType() *NetworkInstance_Protocol_Bgp_PeerGroup_SendCommunityTypePathAny {
	return &NetworkInstance_Protocol_Bgp_PeerGroup_SendCommunityTypePathAny{
		NodePath: ygot.NewNodePath(
			[]string{"config", "send-community-type"},
			map[string]interface{}{},
			n,
