...
// EthernetSegment_Esi_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-ethernet-segments/ethernet-segments/ethernet-segment/config/esi within the YANG schema.
// Union type can be one of [E_EthernetSegment_Esi_Enum, UnionString].
type EthernetSegment_Esi_Union interface {
	// Union type can be one of [E_EthernetSegment_Esi_Enum, UnionString]
	Documentation_for_EthernetSegment_Esi_Union()
}

// Documentation_for_EthernetSegment_Esi_Union ensures that E_EthernetSegment_Esi_Enum
// implements the EthernetSegment_Esi_Union interface.
func (E_EthernetSegment_Esi_Enum) Documentation_for_EthernetSegment_Esi_Union() {}

// Documentation_for_EthernetSegment_Esi_Union ensures that UnionString
// implements the EthernetSegment_Esi_Union interface.
func (UnionString) Documentation_for_EthernetSegment_Esi_Union() {}

// To_EthernetSegment_Esi_Union takes an input interface{} and attempts to convert it to a struct
// which implements the EthernetSegment_Esi_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *EthernetSegment) To_EthernetSegment_Esi_Union(i interface{}) (EthernetSegment_Esi_Union, error) {
	if v, ok := i.(EthernetSegment_Esi_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case string:
	...
	return nil, fmt.Errorf("cannot convert %v to EthernetSegment_Esi_Union, unknown union type, got: %T, want any of [E_EthernetSegment_Esi_Enum, string]", i, i)
}
...
// for the leaf /openconfig-keychain/keychains/keychain/keys/key/config/key-id within the YANG schema.
...
// Documentation_for_NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_FlexAlgoPrefixSid_SidId_Union ensures that E_MplsTypes_MplsLabel_Enum
// implements the NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_FlexAlgoPrefixSid_SidId_Union interface.
func (E_MplsTypes_MplsLabel_Enum) Documentation_for_NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_FlexAlgoPrefixSid_SidId_Union() {
}
...
func (t *NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_FlexAlgoPrefixSid) To_NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_FlexAlgoPrefixSid_SidId_Union(i interface{}) (NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_FlexAlgoPrefixSid_SidId_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_FlexAlgoPrefixSid_SidId_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, string, uint32]", i, i)
}
...
// for the leaf /openconfig-qos/qos/classifiers/classifier/terms/term/conditions/mpls/config/end-label-value within the YANG schema.
// Union type can be one of [E_MplsTypes_MplsLabel_Enum, UnionUint32].
...
// for the leaf /openconfig-qos/qos/classifiers/classifier/terms/term/conditions/mpls/config/start-label-value within the YANG schema.
// Union type can be one of [E_MplsTypes_MplsLabel_Enum, UnionUint32].
...
// for the leaf /openconfig-routing-policy/routing-policy/defined-sets/bgp-defined-sets/community-sets/community-set/config/community-member within the YANG schema.
// Union type can be one of [E_BgpTypes_BGP_WELL_KNOWN_STD_COMMUNITY, UnionString, UnionUint32].
...
// for the leaf /openconfig-routing-policy/routing-policy/policy-definitions/policy-definition/statements/statement/actions/bgp-actions/config/set-med within the YANG schema.
...
// for the leaf /openconfig-routing-policy/routing-policy/policy-definitions/policy-definition/statements/statement/actions/bgp-actions/config/set-next-hop within the YANG schema.
...
// for the leaf /openconfig-routing-policy/routing-policy/policy-definitions/policy-definition/statements/statement/actions/bgp-actions/set-community/inline/config/communities within the YANG schema.
// Union type can be one of [E_BgpTypes_BGP_WELL_KNOWN_STD_COMMUNITY, UnionString, UnionUint32].
...
// for the leaf /openconfig-routing-policy/routing-policy/policy-definitions/policy-definition/statements/statement/actions/bgp-actions/set-ext-community/inline/config/communities within the YANG schema.
...
// for the leaf /openconfig-routing-policy/routing-policy/policy-definitions/policy-definition/statements/statement/actions/ospf-actions/config/set-area within the YANG schema.
// Union type can be one of [UnionString, UnionUint32].
...
// for the leaf /openconfig-routing-policy/routing-policy/policy-definitions/policy-definition/statements/statement/conditions/ospf-conditions/config/area-eq within the YANG schema.
// Union type can be one of [UnionString, UnionUint32].
...
type Stp_Mstp_MstInstance_Vlan_Union interface {
	// Union type can be one of [UnionString, UnionUint16]
	Documentation_for_Stp_Mstp_MstInstance_Vlan_Union()
}

// Documentation_for_Stp_Mstp_MstInstance_Vlan_Union ensures that UnionString
// implements the Stp_Mstp_MstInstance_Vlan_Union interface.
func (UnionString) Documentation_for_Stp_Mstp_MstInstance_Vlan_Union() {}

// Documentation_for_Stp_Mstp_MstInstance_Vlan_Union ensures that UnionUint16
// implements the Stp_Mstp_MstInstance_Vlan_Union interface.
func (UnionUint16) Documentation_for_Stp_Mstp_MstInstance_Vlan_Union() {}
...
func (t *Stp_Mstp_MstInstance) To_Stp_Mstp_MstInstance_Vlan_Union(i interface{}) (Stp_Mstp_MstInstance_Vlan_Union, error) {
	if v, ok := i.(Stp_Mstp_MstInstance_Vlan_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case string:
...
// for the leaf /openconfig-system/system/grpc-servers/grpc-server/config/listen-addresses within the YANG schema.
