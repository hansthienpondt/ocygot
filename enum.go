...
// E_ApsModule_ForceToPort is a derived int64 type which is used to represent
// the enumerated node ApsModule_ForceToPort. An additional value named
// ApsModule_ForceToPort_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_ApsModule_ForceToPort int64

// IsYANGGoEnum ensures that ApsModule_ForceToPort implements the yang.GoEnum
// interface. This ensures that ApsModule_ForceToPort can be identified as a
// mapped type for a YANG enumeration.
func (E_ApsModule_ForceToPort) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  ApsModule_ForceToPort.
func (E_ApsModule_ForceToPort) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_ApsModule_ForceToPort.
func (e E_ApsModule_ForceToPort) String() string {
	return ygot.EnumLogString(e, int64(e), "E_ApsModule_ForceToPort")
}

const (
	// ApsModule_ForceToPort_UNSET corresponds to the value UNSET of ApsModule_ForceToPort
	ApsModule_ForceToPort_UNSET E_ApsModule_ForceToPort = 0
	// ApsModule_ForceToPort_NONE corresponds to the value NONE of ApsModule_ForceToPort
	ApsModule_ForceToPort_NONE E_ApsModule_ForceToPort = 1
	// ApsModule_ForceToPort_PRIMARY corresponds to the value PRIMARY of ApsModule_ForceToPort
	ApsModule_ForceToPort_PRIMARY E_ApsModule_ForceToPort = 2
	// ApsModule_ForceToPort_SECONDARY corresponds to the value SECONDARY of ApsModule_ForceToPort
	ApsModule_ForceToPort_SECONDARY E_ApsModule_ForceToPort = 3
)
...
const (
	...
	// BgpTypes_CommunityType_LARGE corresponds to the value LARGE of BgpTypes_CommunityType
	BgpTypes_CommunityType_LARGE E_BgpTypes_CommunityType = 3
	// BgpTypes_CommunityType_BOTH corresponds to the value BOTH of BgpTypes_CommunityType
	BgpTypes_CommunityType_BOTH E_BgpTypes_CommunityType = 4
	// BgpTypes_CommunityType_NONE corresponds to the value NONE of BgpTypes_CommunityType
	BgpTypes_CommunityType_NONE E_BgpTypes_CommunityType = 5
)
...
// E_Flexalgo_FlexAlgoMetricType is a derived int64 type which is used to represent
// the enumerated node Flexalgo_FlexAlgoMetricType. An additional value named
// Flexalgo_FlexAlgoMetricType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Flexalgo_FlexAlgoMetricType int64

// IsYANGGoEnum ensures that Flexalgo_FlexAlgoMetricType implements the yang.GoEnum
// interface. This ensures that Flexalgo_FlexAlgoMetricType can be identified as a
// mapped type for a YANG enumeration.
func (E_Flexalgo_FlexAlgoMetricType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Flexalgo_FlexAlgoMetricType.
func (E_Flexalgo_FlexAlgoMetricType) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Flexalgo_FlexAlgoMetricType.
func (e E_Flexalgo_FlexAlgoMetricType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Flexalgo_FlexAlgoMetricType")
}

const (
	// Flexalgo_FlexAlgoMetricType_UNSET corresponds to the value UNSET of Flexalgo_FlexAlgoMetricType
	Flexalgo_FlexAlgoMetricType_UNSET E_Flexalgo_FlexAlgoMetricType = 0
	// Flexalgo_FlexAlgoMetricType_IGP corresponds to the value IGP of Flexalgo_FlexAlgoMetricType
	Flexalgo_FlexAlgoMetricType_IGP E_Flexalgo_FlexAlgoMetricType = 1
	// Flexalgo_FlexAlgoMetricType_MIN_DELAY corresponds to the value MIN_DELAY of Flexalgo_FlexAlgoMetricType
	Flexalgo_FlexAlgoMetricType_MIN_DELAY E_Flexalgo_FlexAlgoMetricType = 2
	// Flexalgo_FlexAlgoMetricType_TE_METRIC corresponds to the value TE_METRIC of Flexalgo_FlexAlgoMetricType
	Flexalgo_FlexAlgoMetricType_TE_METRIC E_Flexalgo_FlexAlgoMetricType = 3
)
...
// E_MacsecTypes_ConfidentialityOffset is a derived int64 type which is used to represent
// the enumerated node MacsecTypes_ConfidentialityOffset. An additional value named
// MacsecTypes_ConfidentialityOffset_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_MacsecTypes_ConfidentialityOffset int64

// IsYANGGoEnum ensures that MacsecTypes_ConfidentialityOffset implements the yang.GoEnum
// interface. This ensures that MacsecTypes_ConfidentialityOffset can be identified as a
// mapped type for a YANG enumeration.
func (E_MacsecTypes_ConfidentialityOffset) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  MacsecTypes_ConfidentialityOffset.
func (E_MacsecTypes_ConfidentialityOffset) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_MacsecTypes_ConfidentialityOffset.
func (e E_MacsecTypes_ConfidentialityOffset) String() string {
	return ygot.EnumLogString(e, int64(e), "E_MacsecTypes_ConfidentialityOffset")
}

const (
	// MacsecTypes_ConfidentialityOffset_UNSET corresponds to the value UNSET of MacsecTypes_ConfidentialityOffset
	MacsecTypes_ConfidentialityOffset_UNSET E_MacsecTypes_ConfidentialityOffset = 0
	// MacsecTypes_ConfidentialityOffset_0_BYTES corresponds to the value 0_BYTES of MacsecTypes_ConfidentialityOffset
	MacsecTypes_ConfidentialityOffset_0_BYTES E_MacsecTypes_ConfidentialityOffset = 1
	// MacsecTypes_ConfidentialityOffset_30_BYTES corresponds to the value 30_BYTES of MacsecTypes_ConfidentialityOffset
	MacsecTypes_ConfidentialityOffset_30_BYTES E_MacsecTypes_ConfidentialityOffset = 2
	// MacsecTypes_ConfidentialityOffset_50_BYTES corresponds to the value 50_BYTES of MacsecTypes_ConfidentialityOffset
	MacsecTypes_ConfidentialityOffset_50_BYTES E_MacsecTypes_ConfidentialityOffset = 3
)

// E_MacsecTypes_MacsecCipherSuite is a derived int64 type which is used to represent
// the enumerated node MacsecTypes_MacsecCipherSuite. An additional value named
// MacsecTypes_MacsecCipherSuite_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_MacsecTypes_MacsecCipherSuite int64

// IsYANGGoEnum ensures that MacsecTypes_MacsecCipherSuite implements the yang.GoEnum
// interface. This ensures that MacsecTypes_MacsecCipherSuite can be identified as a
// mapped type for a YANG enumeration.
func (E_MacsecTypes_MacsecCipherSuite) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  MacsecTypes_MacsecCipherSuite.
func (E_MacsecTypes_MacsecCipherSuite) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_MacsecTypes_MacsecCipherSuite.
func (e E_MacsecTypes_MacsecCipherSuite) String() string {
	return ygot.EnumLogString(e, int64(e), "E_MacsecTypes_MacsecCipherSuite")
}

const (
	// MacsecTypes_MacsecCipherSuite_UNSET corresponds to the value UNSET of MacsecTypes_MacsecCipherSuite
	MacsecTypes_MacsecCipherSuite_UNSET E_MacsecTypes_MacsecCipherSuite = 0
	// MacsecTypes_MacsecCipherSuite_GCM_AES_128 corresponds to the value GCM_AES_128 of MacsecTypes_MacsecCipherSuite
	MacsecTypes_MacsecCipherSuite_GCM_AES_128 E_MacsecTypes_MacsecCipherSuite = 1
	// MacsecTypes_MacsecCipherSuite_GCM_AES_256 corresponds to the value GCM_AES_256 of MacsecTypes_MacsecCipherSuite
	MacsecTypes_MacsecCipherSuite_GCM_AES_256 E_MacsecTypes_MacsecCipherSuite = 2
	// MacsecTypes_MacsecCipherSuite_GCM_AES_XPN_128 corresponds to the value GCM_AES_XPN_128 of MacsecTypes_MacsecCipherSuite
	MacsecTypes_MacsecCipherSuite_GCM_AES_XPN_128 E_MacsecTypes_MacsecCipherSuite = 3
	// MacsecTypes_MacsecCipherSuite_GCM_AES_XPN_256 corresponds to the value GCM_AES_XPN_256 of MacsecTypes_MacsecCipherSuite
	MacsecTypes_MacsecCipherSuite_GCM_AES_XPN_256 E_MacsecTypes_MacsecCipherSuite = 4
)
...
// E_ProbesTypes_TestType is a derived int64 type which is used to represent
// the enumerated node ProbesTypes_TestType. An additional value named
// ProbesTypes_TestType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_ProbesTypes_TestType int64

// IsYANGGoEnum ensures that ProbesTypes_TestType implements the yang.GoEnum
// interface. This ensures that ProbesTypes_TestType can be identified as a
// mapped type for a YANG enumeration.
func (E_ProbesTypes_TestType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  ProbesTypes_TestType.
func (E_ProbesTypes_TestType) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_ProbesTypes_TestType.
func (e E_ProbesTypes_TestType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_ProbesTypes_TestType")
}

const (
	// ProbesTypes_TestType_UNSET corresponds to the value UNSET of ProbesTypes_TestType
	ProbesTypes_TestType_UNSET E_ProbesTypes_TestType = 0
	// ProbesTypes_TestType_ICMP corresponds to the value ICMP of ProbesTypes_TestType
	ProbesTypes_TestType_ICMP E_ProbesTypes_TestType = 1
	// ProbesTypes_TestType_ICMP6 corresponds to the value ICMP6 of ProbesTypes_TestType
	ProbesTypes_TestType_ICMP6 E_ProbesTypes_TestType = 2
	// ProbesTypes_TestType_ICMP_TIMESTAMP corresponds to the value ICMP_TIMESTAMP of ProbesTypes_TestType
	ProbesTypes_TestType_ICMP_TIMESTAMP E_ProbesTypes_TestType = 3
	// ProbesTypes_TestType_ICMP6_TIMESTAMP corresponds to the value ICMP6_TIMESTAMP of ProbesTypes_TestType
	ProbesTypes_TestType_ICMP6_TIMESTAMP E_ProbesTypes_TestType = 4
	// ProbesTypes_TestType_TCP corresponds to the value TCP of ProbesTypes_TestType
	ProbesTypes_TestType_TCP E_ProbesTypes_TestType = 5
	// ProbesTypes_TestType_UDP corresponds to the value UDP of ProbesTypes_TestType
	ProbesTypes_TestType_UDP E_ProbesTypes_TestType = 6
	// ProbesTypes_TestType_UDP_TIMESTAMP corresponds to the value UDP_TIMESTAMP of ProbesTypes_TestType
	ProbesTypes_TestType_UDP_TIMESTAMP E_ProbesTypes_TestType = 7
	// ProbesTypes_TestType_HTTP_GET corresponds to the value HTTP_GET of ProbesTypes_TestType
	ProbesTypes_TestType_HTTP_GET E_ProbesTypes_TestType = 8
	// ProbesTypes_TestType_HTTP_GET_META corresponds to the value HTTP_GET_META of ProbesTypes_TestType
	ProbesTypes_TestType_HTTP_GET_META E_ProbesTypes_TestType = 9
)
...
const (
	...
	SegmentRoutingTypes_SrteProtocolType_PCEP E_SegmentRoutingTypes_SrteProtocolType = 11
	// SegmentRoutingTypes_SrteProtocolType_BGP corresponds to the value BGP of SegmentRoutingTypes_SrteProtocolType
	SegmentRoutingTypes_SrteProtocolType_BGP E_SegmentRoutingTypes_SrteProtocolType = 21
	// SegmentRoutingTypes_SrteProtocolType_CONFIG corresponds to the value CONFIG of SegmentRoutingTypes_SrteProtocolType
	SegmentRoutingTypes_SrteProtocolType_CONFIG E_SegmentRoutingTypes_SrteProtocolType = 31
)
...
// E_SpanningTreeTypes_STP_EDGE_PORT is a derived int64 type which is used to represent
// the enumerated node SpanningTreeTypes_STP_EDGE_PORT. An additional value named
// SpanningTreeTypes_STP_EDGE_PORT_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_SpanningTreeTypes_STP_EDGE_PORT int64

// IsYANGGoEnum ensures that SpanningTreeTypes_STP_EDGE_PORT implements the yang.GoEnum
// interface. This ensures that SpanningTreeTypes_STP_EDGE_PORT can be identified as a
// mapped type for a YANG enumeration.
func (E_SpanningTreeTypes_STP_EDGE_PORT) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  SpanningTreeTypes_STP_EDGE_PORT.
func (E_SpanningTreeTypes_STP_EDGE_PORT) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_SpanningTreeTypes_STP_EDGE_PORT.
func (e E_SpanningTreeTypes_STP_EDGE_PORT) String() string {
	return ygot.EnumLogString(e, int64(e), "E_SpanningTreeTypes_STP_EDGE_PORT")
}

const (
	// SpanningTreeTypes_STP_EDGE_PORT_UNSET corresponds to the value UNSET of SpanningTreeTypes_STP_EDGE_PORT
	SpanningTreeTypes_STP_EDGE_PORT_UNSET E_SpanningTreeTypes_STP_EDGE_PORT = 0
	// SpanningTreeTypes_STP_EDGE_PORT_EDGE_AUTO corresponds to the value EDGE_AUTO of SpanningTreeTypes_STP_EDGE_PORT
	SpanningTreeTypes_STP_EDGE_PORT_EDGE_AUTO E_SpanningTreeTypes_STP_EDGE_PORT = 1
	// SpanningTreeTypes_STP_EDGE_PORT_EDGE_DISABLE corresponds to the value EDGE_DISABLE of SpanningTreeTypes_STP_EDGE_PORT
	SpanningTreeTypes_STP_EDGE_PORT_EDGE_DISABLE E_SpanningTreeTypes_STP_EDGE_PORT = 2
	// SpanningTreeTypes_STP_EDGE_PORT_EDGE_ENABLE corresponds to the value EDGE_ENABLE of SpanningTreeTypes_STP_EDGE_PORT
	SpanningTreeTypes_STP_EDGE_PORT_EDGE_ENABLE E_SpanningTreeTypes_STP_EDGE_PORT = 3
)

// E_SpanningTreeTypes_STP_PORT_ROLE is a derived int64 type which is used to represent
// the enumerated node SpanningTreeTypes_STP_PORT_ROLE. An additional value named
// SpanningTreeTypes_STP_PORT_ROLE_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_SpanningTreeTypes_STP_PORT_ROLE int64

// IsYANGGoEnum ensures that SpanningTreeTypes_STP_PORT_ROLE implements the yang.GoEnum
// interface. This ensures that SpanningTreeTypes_STP_PORT_ROLE can be identified as a
// mapped type for a YANG enumeration.
func (E_SpanningTreeTypes_STP_PORT_ROLE) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  SpanningTreeTypes_STP_PORT_ROLE.
func (E_SpanningTreeTypes_STP_PORT_ROLE) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_SpanningTreeTypes_STP_PORT_ROLE.
func (e E_SpanningTreeTypes_STP_PORT_ROLE) String() string {
	return ygot.EnumLogString(e, int64(e), "E_SpanningTreeTypes_STP_PORT_ROLE")
}

const (
	// SpanningTreeTypes_STP_PORT_ROLE_UNSET corresponds to the value UNSET of SpanningTreeTypes_STP_PORT_ROLE
	SpanningTreeTypes_STP_PORT_ROLE_UNSET E_SpanningTreeTypes_STP_PORT_ROLE = 0
	// SpanningTreeTypes_STP_PORT_ROLE_ALTERNATE corresponds to the value ALTERNATE of SpanningTreeTypes_STP_PORT_ROLE
	SpanningTreeTypes_STP_PORT_ROLE_ALTERNATE E_SpanningTreeTypes_STP_PORT_ROLE = 1
	// SpanningTreeTypes_STP_PORT_ROLE_BACKUP corresponds to the value BACKUP of SpanningTreeTypes_STP_PORT_ROLE
	SpanningTreeTypes_STP_PORT_ROLE_BACKUP E_SpanningTreeTypes_STP_PORT_ROLE = 2
	// SpanningTreeTypes_STP_PORT_ROLE_DESIGNATED corresponds to the value DESIGNATED of SpanningTreeTypes_STP_PORT_ROLE
	SpanningTreeTypes_STP_PORT_ROLE_DESIGNATED E_SpanningTreeTypes_STP_PORT_ROLE = 3
	// SpanningTreeTypes_STP_PORT_ROLE_ROOT corresponds to the value ROOT of SpanningTreeTypes_STP_PORT_ROLE
	SpanningTreeTypes_STP_PORT_ROLE_ROOT E_SpanningTreeTypes_STP_PORT_ROLE = 4
)

// E_SpanningTreeTypes_STP_PORT_STATE is a derived int64 type which is used to represent
// the enumerated node SpanningTreeTypes_STP_PORT_STATE. An additional value named
// SpanningTreeTypes_STP_PORT_STATE_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_SpanningTreeTypes_STP_PORT_STATE int64

// IsYANGGoEnum ensures that SpanningTreeTypes_STP_PORT_STATE implements the yang.GoEnum
// interface. This ensures that SpanningTreeTypes_STP_PORT_STATE can be identified as a
// mapped type for a YANG enumeration.
func (E_SpanningTreeTypes_STP_PORT_STATE) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  SpanningTreeTypes_STP_PORT_STATE.
func (E_SpanningTreeTypes_STP_PORT_STATE) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_SpanningTreeTypes_STP_PORT_STATE.
func (e E_SpanningTreeTypes_STP_PORT_STATE) String() string {
	return ygot.EnumLogString(e, int64(e), "E_SpanningTreeTypes_STP_PORT_STATE")
}

const (
	// SpanningTreeTypes_STP_PORT_STATE_UNSET corresponds to the value UNSET of SpanningTreeTypes_STP_PORT_STATE
	SpanningTreeTypes_STP_PORT_STATE_UNSET E_SpanningTreeTypes_STP_PORT_STATE = 0
	// SpanningTreeTypes_STP_PORT_STATE_BLOCKING corresponds to the value BLOCKING of SpanningTreeTypes_STP_PORT_STATE
	SpanningTreeTypes_STP_PORT_STATE_BLOCKING E_SpanningTreeTypes_STP_PORT_STATE = 1
	// SpanningTreeTypes_STP_PORT_STATE_DISABLED corresponds to the value DISABLED of SpanningTreeTypes_STP_PORT_STATE
	SpanningTreeTypes_STP_PORT_STATE_DISABLED E_SpanningTreeTypes_STP_PORT_STATE = 2
	// SpanningTreeTypes_STP_PORT_STATE_FORWARDING corresponds to the value FORWARDING of SpanningTreeTypes_STP_PORT_STATE
	SpanningTreeTypes_STP_PORT_STATE_FORWARDING E_SpanningTreeTypes_STP_PORT_STATE = 3
	// SpanningTreeTypes_STP_PORT_STATE_LEARNING corresponds to the value LEARNING of SpanningTreeTypes_STP_PORT_STATE
	SpanningTreeTypes_STP_PORT_STATE_LEARNING E_SpanningTreeTypes_STP_PORT_STATE = 4
	// SpanningTreeTypes_STP_PORT_STATE_LISTENING corresponds to the value LISTENING of SpanningTreeTypes_STP_PORT_STATE
	SpanningTreeTypes_STP_PORT_STATE_LISTENING E_SpanningTreeTypes_STP_PORT_STATE = 5
)

// E_SpanningTreeTypes_STP_PROTOCOL is a derived int64 type which is used to represent
// the enumerated node SpanningTreeTypes_STP_PROTOCOL. An additional value named
// SpanningTreeTypes_STP_PROTOCOL_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_SpanningTreeTypes_STP_PROTOCOL int64

// IsYANGGoEnum ensures that SpanningTreeTypes_STP_PROTOCOL implements the yang.GoEnum
// interface. This ensures that SpanningTreeTypes_STP_PROTOCOL can be identified as a
// mapped type for a YANG enumeration.
func (E_SpanningTreeTypes_STP_PROTOCOL) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  SpanningTreeTypes_STP_PROTOCOL.
func (E_SpanningTreeTypes_STP_PROTOCOL) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_SpanningTreeTypes_STP_PROTOCOL.
func (e E_SpanningTreeTypes_STP_PROTOCOL) String() string {
	return ygot.EnumLogString(e, int64(e), "E_SpanningTreeTypes_STP_PROTOCOL")
}

const (
	// SpanningTreeTypes_STP_PROTOCOL_UNSET corresponds to the value UNSET of SpanningTreeTypes_STP_PROTOCOL
	SpanningTreeTypes_STP_PROTOCOL_UNSET E_SpanningTreeTypes_STP_PROTOCOL = 0
	// SpanningTreeTypes_STP_PROTOCOL_MSTP corresponds to the value MSTP of SpanningTreeTypes_STP_PROTOCOL
	SpanningTreeTypes_STP_PROTOCOL_MSTP E_SpanningTreeTypes_STP_PROTOCOL = 1
	// SpanningTreeTypes_STP_PROTOCOL_RAPID_PVST corresponds to the value RAPID_PVST of SpanningTreeTypes_STP_PROTOCOL
	SpanningTreeTypes_STP_PROTOCOL_RAPID_PVST E_SpanningTreeTypes_STP_PROTOCOL = 2
	// SpanningTreeTypes_STP_PROTOCOL_RSTP corresponds to the value RSTP of SpanningTreeTypes_STP_PROTOCOL
	SpanningTreeTypes_STP_PROTOCOL_RSTP E_SpanningTreeTypes_STP_PROTOCOL = 3
)

// E_SpanningTreeTypes_StpGuardType is a derived int64 type which is used to represent
// the enumerated node SpanningTreeTypes_StpGuardType. An additional value named
// SpanningTreeTypes_StpGuardType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_SpanningTreeTypes_StpGuardType int64

// IsYANGGoEnum ensures that SpanningTreeTypes_StpGuardType implements the yang.GoEnum
// interface. This ensures that SpanningTreeTypes_StpGuardType can be identified as a
// mapped type for a YANG enumeration.
func (E_SpanningTreeTypes_StpGuardType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  SpanningTreeTypes_StpGuardType.
func (E_SpanningTreeTypes_StpGuardType) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_SpanningTreeTypes_StpGuardType.
func (e E_SpanningTreeTypes_StpGuardType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_SpanningTreeTypes_StpGuardType")
}

const (
	// SpanningTreeTypes_StpGuardType_UNSET corresponds to the value UNSET of SpanningTreeTypes_StpGuardType
	SpanningTreeTypes_StpGuardType_UNSET E_SpanningTreeTypes_StpGuardType = 0
	// SpanningTreeTypes_StpGuardType_ROOT corresponds to the value ROOT of SpanningTreeTypes_StpGuardType
	SpanningTreeTypes_StpGuardType_ROOT E_SpanningTreeTypes_StpGuardType = 1
	// SpanningTreeTypes_StpGuardType_LOOP corresponds to the value LOOP of SpanningTreeTypes_StpGuardType
	SpanningTreeTypes_StpGuardType_LOOP E_SpanningTreeTypes_StpGuardType = 2
	// SpanningTreeTypes_StpGuardType_NONE corresponds to the value NONE of SpanningTreeTypes_StpGuardType
	SpanningTreeTypes_StpGuardType_NONE E_SpanningTreeTypes_StpGuardType = 3
)

// E_SpanningTreeTypes_StpLinkType is a derived int64 type which is used to represent
// the enumerated node SpanningTreeTypes_StpLinkType. An additional value named
// SpanningTreeTypes_StpLinkType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_SpanningTreeTypes_StpLinkType int64

// IsYANGGoEnum ensures that SpanningTreeTypes_StpLinkType implements the yang.GoEnum
// interface. This ensures that SpanningTreeTypes_StpLinkType can be identified as a
// mapped type for a YANG enumeration.
func (E_SpanningTreeTypes_StpLinkType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  SpanningTreeTypes_StpLinkType.
func (E_SpanningTreeTypes_StpLinkType) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_SpanningTreeTypes_StpLinkType.
func (e E_SpanningTreeTypes_StpLinkType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_SpanningTreeTypes_StpLinkType")
}

const (
	// SpanningTreeTypes_StpLinkType_UNSET corresponds to the value UNSET of SpanningTreeTypes_StpLinkType
	SpanningTreeTypes_StpLinkType_UNSET E_SpanningTreeTypes_StpLinkType = 0
	// SpanningTreeTypes_StpLinkType_P2P corresponds to the value P2P of SpanningTreeTypes_StpLinkType
	SpanningTreeTypes_StpLinkType_P2P E_SpanningTreeTypes_StpLinkType = 1
	// SpanningTreeTypes_StpLinkType_SHARED corresponds to the value SHARED of SpanningTreeTypes_StpLinkType
	SpanningTreeTypes_StpLinkType_SHARED E_SpanningTreeTypes_StpLinkType = 2
)
...
const (
	...
	SystemGrpc_GRPC_SERVICE_GRIBI E_SystemGrpc_GRPC_SERVICE = 2
)
...
// E_TelemetryTypes_DATA_ENCODING_METHOD is a derived int64 type which is used to represent
// the enumerated node TelemetryTypes_DATA_ENCODING_METHOD. An additional value named
// TelemetryTypes_DATA_ENCODING_METHOD_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_TelemetryTypes_DATA_ENCODING_METHOD int64

// IsYANGGoEnum ensures that TelemetryTypes_DATA_ENCODING_METHOD implements the yang.GoEnum
// interface. This ensures that TelemetryTypes_DATA_ENCODING_METHOD can be identified as a
// mapped type for a YANG enumeration.
func (E_TelemetryTypes_DATA_ENCODING_METHOD) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  TelemetryTypes_DATA_ENCODING_METHOD.
func (E_TelemetryTypes_DATA_ENCODING_METHOD) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_TelemetryTypes_DATA_ENCODING_METHOD.
func (e E_TelemetryTypes_DATA_ENCODING_METHOD) String() string {
	return ygot.EnumLogString(e, int64(e), "E_TelemetryTypes_DATA_ENCODING_METHOD")
}

const (
	// TelemetryTypes_DATA_ENCODING_METHOD_UNSET corresponds to the value UNSET of TelemetryTypes_DATA_ENCODING_METHOD
	TelemetryTypes_DATA_ENCODING_METHOD_UNSET E_TelemetryTypes_DATA_ENCODING_METHOD = 0
	// TelemetryTypes_DATA_ENCODING_METHOD_ENC_JSON_IETF corresponds to the value ENC_JSON_IETF of TelemetryTypes_DATA_ENCODING_METHOD
	TelemetryTypes_DATA_ENCODING_METHOD_ENC_JSON_IETF E_TelemetryTypes_DATA_ENCODING_METHOD = 1
	// TelemetryTypes_DATA_ENCODING_METHOD_ENC_PROTO3 corresponds to the value ENC_PROTO3 of TelemetryTypes_DATA_ENCODING_METHOD
	TelemetryTypes_DATA_ENCODING_METHOD_ENC_PROTO3 E_TelemetryTypes_DATA_ENCODING_METHOD = 2
	// TelemetryTypes_DATA_ENCODING_METHOD_ENC_XML corresponds to the value ENC_XML of TelemetryTypes_DATA_ENCODING_METHOD
	TelemetryTypes_DATA_ENCODING_METHOD_ENC_XML E_TelemetryTypes_DATA_ENCODING_METHOD = 3
)

// E_TelemetryTypes_STREAM_PROTOCOL is a derived int64 type which is used to represent
// the enumerated node TelemetryTypes_STREAM_PROTOCOL. An additional value named
// TelemetryTypes_STREAM_PROTOCOL_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_TelemetryTypes_STREAM_PROTOCOL int64

// IsYANGGoEnum ensures that TelemetryTypes_STREAM_PROTOCOL implements the yang.GoEnum
// interface. This ensures that TelemetryTypes_STREAM_PROTOCOL can be identified as a
// mapped type for a YANG enumeration.
func (E_TelemetryTypes_STREAM_PROTOCOL) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  TelemetryTypes_STREAM_PROTOCOL.
func (E_TelemetryTypes_STREAM_PROTOCOL) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_TelemetryTypes_STREAM_PROTOCOL.
func (e E_TelemetryTypes_STREAM_PROTOCOL) String() string {
	return ygot.EnumLogString(e, int64(e), "E_TelemetryTypes_STREAM_PROTOCOL")
}

const (
	// TelemetryTypes_STREAM_PROTOCOL_UNSET corresponds to the value UNSET of TelemetryTypes_STREAM_PROTOCOL
	TelemetryTypes_STREAM_PROTOCOL_UNSET E_TelemetryTypes_STREAM_PROTOCOL = 0
	// TelemetryTypes_STREAM_PROTOCOL_STREAM_GRPC corresponds to the value STREAM_GRPC of TelemetryTypes_STREAM_PROTOCOL
	TelemetryTypes_STREAM_PROTOCOL_STREAM_GRPC E_TelemetryTypes_STREAM_PROTOCOL = 1
	// TelemetryTypes_STREAM_PROTOCOL_STREAM_JSON_RPC corresponds to the value STREAM_JSON_RPC of TelemetryTypes_STREAM_PROTOCOL
	TelemetryTypes_STREAM_PROTOCOL_STREAM_JSON_RPC E_TelemetryTypes_STREAM_PROTOCOL = 2
	// TelemetryTypes_STREAM_PROTOCOL_STREAM_SSH corresponds to the value STREAM_SSH of TelemetryTypes_STREAM_PROTOCOL
	TelemetryTypes_STREAM_PROTOCOL_STREAM_SSH E_TelemetryTypes_STREAM_PROTOCOL = 3
	// TelemetryTypes_STREAM_PROTOCOL_STREAM_THRIFT_RPC corresponds to the value STREAM_THRIFT_RPC of TelemetryTypes_STREAM_PROTOCOL
	TelemetryTypes_STREAM_PROTOCOL_STREAM_THRIFT_RPC E_TelemetryTypes_STREAM_PROTOCOL = 4
	// TelemetryTypes_STREAM_PROTOCOL_STREAM_WEBSOCKET_RPC corresponds to the value STREAM_WEBSOCKET_RPC of TelemetryTypes_STREAM_PROTOCOL
	TelemetryTypes_STREAM_PROTOCOL_STREAM_WEBSOCKET_RPC E_TelemetryTypes_STREAM_PROTOCOL = 5
)
...
// E_TransportLineProtection_APS_PATHS is a derived int64 type which is used to represent
// the enumerated node TransportLineProtection_APS_PATHS. An additional value named
// TransportLineProtection_APS_PATHS_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_TransportLineProtection_APS_PATHS int64

// IsYANGGoEnum ensures that TransportLineProtection_APS_PATHS implements the yang.GoEnum
// interface. This ensures that TransportLineProtection_APS_PATHS can be identified as a
// mapped type for a YANG enumeration.
func (E_TransportLineProtection_APS_PATHS) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  TransportLineProtection_APS_PATHS.
func (E_TransportLineProtection_APS_PATHS) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_TransportLineProtection_APS_PATHS.
func (e E_TransportLineProtection_APS_PATHS) String() string {
	return ygot.EnumLogString(e, int64(e), "E_TransportLineProtection_APS_PATHS")
}

const (
	// TransportLineProtection_APS_PATHS_UNSET corresponds to the value UNSET of TransportLineProtection_APS_PATHS
	TransportLineProtection_APS_PATHS_UNSET E_TransportLineProtection_APS_PATHS = 0
	// TransportLineProtection_APS_PATHS_PRIMARY corresponds to the value PRIMARY of TransportLineProtection_APS_PATHS
	TransportLineProtection_APS_PATHS_PRIMARY E_TransportLineProtection_APS_PATHS = 1
	// TransportLineProtection_APS_PATHS_SECONDARY corresponds to the value SECONDARY of TransportLineProtection_APS_PATHS
	TransportLineProtection_APS_PATHS_SECONDARY E_TransportLineProtection_APS_PATHS = 2
)
